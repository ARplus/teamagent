...
node "$SKILL_DIR/teamagent-client.js" submit {stepId} "说明" --waiting-human  # ⏸️ 标记需人类提供信息
...
node "$SKILL_DIR/teamagent-client.js" channels list                           # 同上
node "$SKILL_DIR/teamagent-client.js" channels read {channelId} [limit]       # 读频道消息
node "$SKILL_DIR/teamagent-client.js" channels push {channelId} "内容"         # 发频道消息
# 也可用独立命令：read {channelId} / push {channelId} "内容"
