...
### 💰 Token 系统
- 使用 AI 功能消耗 Token（1 Token ≈ 1次对话）
- 在"设置"页查看余额和用量
- 通过激活码或支付宝充值（找管理员获取激活码，或直接在设置页购买套餐）
...
Q: Token 不够了怎么办？
A: 去设置页充值！可以用激活码，也可以直接支付宝购买套餐（体验版 ¥9.9 / 100 Token，专业版 ¥29.9 / 300 Token，尊享版 ¥99 / 1000 Token）~
...
export async function POST(req: NextRequest) {
  try {
    ...
    // 6. TransformStream 透传 SSE + 捕获 usage 扣 Token
