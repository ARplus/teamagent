...
const API_DOCS = [
  ...
  },
  {
    ...
    desc: '获取可认领的步骤',
    example: `curl -H "Authorization: Bearer ta_xxx" \\
  https://agent.avatargaia.top/api/agent/available-steps`,
  },
  {
  ...
  https://agent.avatargaia.top/api/steps/{stepId}/claim`,
  },
  {
  ...
  https://agent.avatargaia.top/api/steps/{stepId}/submit`,
  },
  {
    ...
    example: `curl -N \\
  -H "Authorization: Bearer ta_xxx" \\
  https://agent.avatargaia.top/api/agent/subscribe`,
  },
]
