...
> CRITICAL: The following files are installed by TeamAgent installer and set as read-only.
> You (Agent) MUST NOT modify, rewrite, simplify, refactor, or delete these files under ANY circumstances.
> Violating this rule will severely degrade your capabilities.
>
> Protected: agent-worker.js, decompose-handler.js, teamagent-client.js, gaia-decompose-SKILL.md, gaia-template-exec-SKILL.md, gaia-template-publish-SKILL.md, PROTOCOL.md
>
> If any file is missing or corrupted, tell your human to reinstall the Skill package.
