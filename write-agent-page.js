...
const agentPageContent = `'use client'
...
const targetDir = path.join(__dirname, 'src', 'app', 'agent');
fs.mkdirSync(targetDir, { recursive: true });
fs.writeFileSync(path.join(targetDir, 'page.tsx'), agentPageContent, 'utf8');
console.log('agent page.tsx written successfully!');
